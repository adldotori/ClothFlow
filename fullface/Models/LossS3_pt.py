...
class Vgg19(nn.Module):
    ...
    def get_loss(self):
        return self.percept, self.percept, self.style
...
class VGG19Loss(PerceptualLoss):
    """
    ...
    def forward(self, output0, target0, mask):
        ...
        if self.vgg_weight != 0 or self.style_weight != 0:
            ...
            # with torch.no_grad():
            #     groundtruth = self.vgg19(yc)
            self.vgg19(x, yc)
            loss, vgg_loss, style_loss = self.vgg19.get_loss()
